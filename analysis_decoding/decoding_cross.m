function [results] = decoding_cross(subj_train, patname_train, regsname_train, selname_train, ...
    subj_test, patname_test, regsname_test, selname_test, class_args,nIterations, varargin)
% Across dataset decoding
